...
The simulation is implemented using a combination of C++ and Python (via the NS-3 Python bindings) and is containerized using Docker for a consistent and reproducible development environment.
